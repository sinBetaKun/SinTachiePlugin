...
ですが、公式の取説がないのはつらいと思いますので、わたくしもサイトを作ってみました。なので、こちらを参考に本プラグインを使ってみてください☟☟☟
<br>https://betajs.onrender.com/stp/index.html
<br>【注意】こちらのサイトは[私のDiscordBot](https://github.com/sinBetaKun/BetaJS)によって動作しているため、こちらが停止するとサイトも停止してしまうので、ご理解お願いします。
<br>また、初期リリース版はユーザーもなかなか使い慣れない、あるいは、説明書アリでも全く使い方が理解できないと思われますので、私がユーザーの質問に対して直々に答えられるよう、
