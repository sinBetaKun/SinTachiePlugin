...
{
    public class PartsListControllerForShapeViewModel : Bindable, INotifyPropertyChanged, IPropertyEditorControl, IDisposable
    {
        ...
        public PartsListControllerForShapeViewModel(ItemProperty[] properties)
        {
