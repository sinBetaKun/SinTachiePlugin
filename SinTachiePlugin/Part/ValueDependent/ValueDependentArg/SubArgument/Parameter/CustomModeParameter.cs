...
using SinTachiePlugin.Part.ValueDependent.ValueDependentArg.SubArgument.Argument;
...
{
    internal class CustomModeParameter : ValueDependentSubArgBase, IDependentModeOfValueParameter
    {
