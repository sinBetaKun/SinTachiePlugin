...
using SinTachiePlugin.Part.LayerInformation.SourceSelectArg.Argument.StartFrameNumber;
using SinTachiePlugin.Part.LayerInformation.SourceSelectArg.Argument.VideoFilePath;
...
{
    internal class VideoFileParameter : SourceSelectArgBase, IParentParameter, IVideoFilePathParameter, IClipParameter, IInsertParameter, IPlaybackSpeedParameter, IStartFrameNumberParameter, ILoopPlaybackParameter
    {
        ...
        public VideoFileParameter(SharedDataStore? store) : base(store)
        {
        }
        ...
        public override void CopyFrom(SourceSelectArgBase? origin)
        {
            ...
            if (origin is IVideoFilePathParameter videoFilePathParameter)
                VideoFilePath = videoFilePathParameter.VideoFilePath;
        ...
        protected override void LoadSharedData(SharedDataStore store)
        {
            ...
            if (store.Load<VideoFilePathSharedData>() is VideoFilePathSharedData videoFilePathSharedData)
