...
{
    internal class PeriodicShuttleParameter : PartAnimationOpeArgBase, IAbrirParameter, ICerrarParameter, IOffsetParameter, IIntervalParameter, ITransitionParameter
    {
        ...
        {
            PeriodicShuttleParameter clone = new();
            clone.CopyFrom(this);
            return clone;
        }
