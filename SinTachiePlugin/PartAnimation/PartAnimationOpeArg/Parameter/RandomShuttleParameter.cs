...
{
    internal class RandomShuttleParameter : PartAnimationOpeArgBase, IAbrirParameter, ICerrarParameter, IOffsetParameter, IIntervalParameter, ISecondaryIntervalParameter, ITransitionParameter
    {
        ...
        public RandomShuttleParameter()
        {
        }

        public RandomShuttleParameter(SharedDataStore? store) : base(store)
        {
        }
        ...
        {
            RandomShuttleParameter clone = new();
            clone.CopyFrom(this);
            return clone;
        }
