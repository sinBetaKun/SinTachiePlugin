...
namespace SinTachiePlugin.PartAnimation.PartAnimationOpeArg.Parameter
{
    ...
    {
        [Display(GroupName = nameof(TextResource.PartAnimationOpeArg_GroupName), Name = nameof(TextResource.PartAnimationOpeArg_Open), ResourceType = typeof(TextResource))]
        [AnimationSlider("F1", "%", -100, 100)]
        public Animation Abrir { get; } = new Animation(100, -10000, 10000);

        [Display(GroupName = nameof(TextResource.PartAnimationOpeArg_GroupName), Name = nameof(TextResource.PartAnimationOpeArg_Close), ResourceType = typeof(TextResource))]
        [AnimationSlider("F1", "%", -100, 100)]
        public Animation Cerrar { get; } = new Animation(0, -10000, 10000);

        [Display(GroupName = nameof(TextResource.PartAnimationOpeArg_GroupName), Name = nameof(TextResource.PartAnimationOpeArg_Silent), ResourceType = typeof(TextResource))]
        [AnimationSlider("F1", "%", -100, 100)]
